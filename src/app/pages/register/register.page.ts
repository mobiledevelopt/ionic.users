...
export class RegisterPage implements OnInit {
  ...
  open(type) {
    // https://#/groceryeeaagya/privacy.html
    // https://#/groceryeeaagya/eula.html
    if (type === 'eula') {
      this.iab.create('https://#/groceryeeaagya/eula.html');
    } else {
      this.iab.create('https://#/groceryeeaagya/privacy.html');
    }
  }
}
