    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "top-picked",
            loadChildren: () =>
              import("../top-picked/top-picked.module").then(
          ...
          },
          {
            path: "top-nine",
            loadChildren: () =>
              import("../top-nine/top-nine.module").then(
                (m) => m.TopNinePageModule
              ),
          },
          {
            path: "ratings",
            loadChildren: () =>
              import("../rating-list/rating-list.module").then(
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadChildren: () =>
              import("../delivery-options/delivery-options.module").then(
          ...
          },
          {
            ...
            loadChildren: () =>
              import("../stripe-payments/stripe-payments.module").then(
