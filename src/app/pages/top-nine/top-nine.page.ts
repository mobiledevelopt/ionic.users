...
@Component({
  selector: 'app-top-nine',
  templateUrl: './top-nine.page.html',
  styleUrls: ['./top-nine.page.scss'],
})
export class TopNinePage implements OnInit {
  ...
  getProducts() {
    ...
    this.api.post('stores/getByCity', param).subscribe((stores: any) => {
      if (stores && stores.status === 200 && stores.data && stores.data.length) {
        ...
        this.dummyProduct = [];
        this.products = [];
        this.api.post('products/getTopNine', param).subscribe((data: any) => {
