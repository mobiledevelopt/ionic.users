...
const routes: Routes = [
  ...
  },
  {
    path: "qris",
    loadChildren: () =>
      import("./pages/qris/qris.module").then((m) => m.QrisPageModule),
  },
  {
    path: "transfer",
    loadChildren: () =>
  ...
  },
  {
    path: "top-picked",
    loadChildren: () =>
      import("./pages/top-picked/top-picked.module").then(
        (m) => m.TopPickedPageModule
      ),
  },
  {
    path: "top-stores",
    loadChildren: () =>
      import("./pages/top-stores/top-stores.module").then(
        (m) => m.TopStoresPageModule
      ),
  },
  {
    path: "all-offers",
    loadChildren: () =>
      import("./pages/all-offers/all-offers.module").then(
        (m) => m.AllOffersPageModule
      ),
  },
  {
    path: "address",
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./pages/stripe-payments/stripe-payments.module").then(
        (m) => m.StripePaymentsPageModule
      ),
  },
  {
    path: "add-card",
  ...
  },
  {
    path: "order-rating",
    loadChildren: () =>
      import("./pages/order-rating/order-rating.module").then(
  ...
  },
  {
    path: "store-rating",
    loadChildren: () =>
      import("./pages/store-rating/store-rating.module").then(
        (m) => m.StoreRatingPageModule
      ),
  },
  {
    path: "product-rating",
    loadChildren: () =>
      import("./pages/product-rating/product-rating.module").then(
        (m) => m.ProductRatingPageModule
      ),
  },
  {
    path: "rating-list",
    loadChildren: () =>
      import("./pages/rating-list/rating-list.module").then(
        (m) => m.RatingListPageModule
      ),
  },
  {
    path: "chats",
  ...
  },
  {
    path: "driver-rating",
    loadChildren: () =>
      import("./pages/driver-rating/driver-rating.module").then(
        (m) => m.DriverRatingPageModule
      ),
  },
  {
    path: "faqs",
